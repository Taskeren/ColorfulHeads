...
import cn.glycol.colorfulheads.ColorfulHeads;
import cn.glycol.colorfulheads.SkullUtils;
...
public class DataManager {
	...
	private static void withDefVal(File file, String...defVal) {
		...
		try {
			...
			ColorfulHeads.LOGGER.error("Unable to write default data into file: {}", file.getName());
		}
	...
	public static List<ItemStack> getSkulls(String name) {
		...
		try {
			...
			ColorfulHeads.LOGGER.error("Unable to read data from file: {}", data.getName());
		}
